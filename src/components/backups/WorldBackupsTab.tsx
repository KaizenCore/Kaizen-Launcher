...
interface WorldBackupsTabProps {
  onStatsChange?: (stats: BackupStats | null) => void
}

export function WorldBackupsTab({ onStatsChange }: WorldBackupsTabProps) {
  ...
  const loadData = async () => {
    try {
      ...
      console.error("[WorldBackupsTab] Failed to load backups:", err)
  ...
  const handleDelete = async () => {
    ...
    try {
      ...
      console.error("[WorldBackupsTab] Failed to delete backup:", err)
  ...
  const handleRestore = async () => {
    ...
    try {
      ...
      console.error("[WorldBackupsTab] Failed to restore backup:", err)
